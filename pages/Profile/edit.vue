                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="w-full lg:w-1/2 space-y-6">
                        ...
                        <div class="space-y-6 max-w-md mx-auto">
                            ...
                            <div>
                                ...
                                <textarea v-model="aboutInput"
                                    class="w-full p-2 border rounded bg-white-100 text-gray-700 resize-none" rows="4"
                    ...
                    <div class="w-full max-w-lg mx-auto space-y-6">
                        ...
                        <div>
                            ...
                            <input v-model="confirmPasswordInput" type="password"
