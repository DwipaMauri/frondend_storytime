  ...
  try {
    ...
    if (error.value) {
      ...
      if (error.value.data && error.value.data.errors) {
        registerState.errors = error.value.data.errors;
      }

      registerState.error = error.value.data?.message || "Registration failed";
      throw error.value;
    }
    ...
    if (data.value) {
      // Set cookies
      const userCookie = useCookie("user_token", {
        maxAge: 7 * 24 * 60 * 60,
        secure: true,
        httpOnly: false,
      });
      ...
      tokenCookie.value = data.value.jwt;
...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div
      class="w-full max-w-8xl grid grid-cols-1 md:grid-cols-2 bg-white border border-gray-200 rounded-lg shadow-lg"
    >
      ...
      <div class="p-8 bg-green-50 flex flex-col justify-between items-start">
        ...
        <div class="w-full flex justify-center">
          <img
            src="/img/undraw_on_the_office_re_cxds 1.png"
            alt="Story Illustration"
            class="max-w-[500px] h-auto"
          />
        </div>
      </div>
      ...
      <div class="p-12">
        ...
        <div
          ...
          class="text-red-500 mb-4 bg-red-50 p-3 rounded"
        >
          {{ registerState.error }}
        </div>
        ...
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <div>
            ...
            />
            <p
              v-if="registerState.errors.name"
          ...
          <div>
            ...
            />
            <p
              v-if="registerState.errors.username"
              class="text-red-500 text-sm mt-1"
            >
          ...
          <div>
            ...
            />
            <p
              v-if="registerState.errors.email"
              class="text-red-500 text-sm mt-1"
            >
          ...
          <div class="relative">
            ...
            <p
              v-if="registerState.errors.password"
              class="text-red-500 text-sm mt-1"
            >
          ...
          <div class="relative">
            ...
            <p
              v-if="registerState.errors.password_confirmation"
              class="text-red-500 text-sm mt-1"
            >
        ...
        <p class="mt-8 text-sm text-gray-600">
          ...
          <a href="/login" class="text-gray asparagus Tr-700 font-medium"
            >Login</a
          >
        </p>
      </div>
